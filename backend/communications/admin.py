...
class AnnouncementAdmin(ModelAdmin, ImportExportModelAdmin):
    ...
    actions = ['publish_announcements', 'send_notifications']
...
class PushNotificationDeviceAdmin(ModelAdmin, ImportExportModelAdmin):
